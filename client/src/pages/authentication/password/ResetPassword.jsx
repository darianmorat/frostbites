            ...
            <div className='form-container'>
               ...
               <div className='right-form'>
                  <form onSubmit={formik.handleSubmit} className="form">
                     <label
                        htmlFor="newPassword"
                        className={formik.touched.newPassword && formik.errors.newPassword ? "red-text" : ""}
                     >
                     ...
                     <label
                        ...
                        className={formik.touched.confirmPassword && formik.errors.confirmPassword ? "red-text" : ""}
                     >
