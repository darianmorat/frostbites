         ...
         >
            <div className='form-container'>
               ...
               <div className='right-form'>
                  <p className='form-description'>Check <span className="your-email">{email}</span> to verify your account and get started.</p>
                  <br/>
                  <button 
                     type='submit' 
                     className='btn secondary-btn btn-submit' 
                     onClick={() => window.open('https://ethereal.email/messages', '_blank')}
                  >
                     OPEN GMAIL
                  </button>
                  <br/>
